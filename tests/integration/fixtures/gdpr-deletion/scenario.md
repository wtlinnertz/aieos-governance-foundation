...
Primary users: EU-based end users who want to exercise their right to erasure. Internal users: legal/compliance team who need to review and approve requests, ops team who currently handles manual deletion. teams: DPO (legal authority), CTO (technical sponsor), head of compliance (audit requirements). We have approximately 45,000 EU-based users out of 200,000 total.
